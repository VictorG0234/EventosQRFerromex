...
Route::middleware('auth')->group(function () {
    ...
    Route::get('events/{event}/attendance-csv', [EventController::class, 'generateAttendanceCsv'])->name('events.attendance.csv');
    Route::get('events/{event}/realtime-logs', [EventController::class, 'realtimeLogs'])->name('events.realtime-logs');
